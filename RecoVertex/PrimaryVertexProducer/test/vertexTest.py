...
from RecoVertex.PrimaryVertexProducer.OfflinePrimaryVertices_cfi import offlinePrimaryVertices#, offlinePrimaryVerticesDumbFitter, offlinePrimaryVerticesCUDA
...
if options.timing:
    ...
    process.FastTimerService = cms.Service('FastTimerService',
        ...
        jsonFileName = cms.untracked.string('resources_'+suff+'.json')
    )
    ####################################################################
...
## modified bc we're changing the fitter anyways lol
process.vertex = offlinePrimaryVertices.clone()


##############################CHANGED
weighted_option = "WeightedMeanFitterCUDA" if options.gpu else "WeightedMeanFitter"
process.vertex.vertexCollections = cms.VPSet(
     [cms.PSet(label=cms.string(""),
               algorithm=cms.string(weighted_option),
