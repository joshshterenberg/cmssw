#ifndef RecoVertex_PrimaryVertexProducer_DAClusterizerInZSubCluster_vect_h
#define RecoVertex_PrimaryVertexProducer_DAClusterizerInZSubCluster_vect_h

/**\class DAClusterizerInZSubCluster_vect
...
class DAClusterizerInZSubCluster_vect final : public TrackClusterizerInZ {
public:
  ...
  DAClusterizerInZSubCluster_vect(const edm::ParameterSet &conf);
